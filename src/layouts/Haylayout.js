...
const switchRoutes = (
  <Switch>
    ...
    <Redirect from="/haylayout" to="/haylayout/table" />
  </Switch>
);
const getRoute = () => {
  ...
  return (
    <div>
      ...
      <Header
        ...
        {...rest}
      />
      <Parallax filter image={require("assets/img/hays.jpg")}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h2>TRANSFORMING HEALTHCARE</h2>
              <h1 className={classes.title}>Genomics as a Service</h1>
              <h4>
              Diagnostics, Drug Discovery, Probiotics
              </h4>
              <br />
              <Button
                color="danger"
                size="lg"
                href="https://www.youtube.com/watch?v=cYMr5QqFojk"
                target="_blank"
